...
from app_old.config import Config, DevelopmentConfig
from app_old.routes.login_user_origin import login_user_origin
...
def google_login(app):
    from app_old import db, google_client
    ...
    def google_callback():
        ...
        # app_old, and now you've verified their email through Google!
