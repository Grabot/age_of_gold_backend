...
def assert_successful_login_dict(
    ...
    response_dict_success: UserTokenData = assert_successful_dict(response_dict)
...
def assert_successful_login(
    ...
    response_dict: UserTokenData = assert_successful(response, status_code)
    assert_successful_login_dict_data(
...
def assert_successful_login_key(
    ...
    response_json: UserTokenData = assert_successful(response)
